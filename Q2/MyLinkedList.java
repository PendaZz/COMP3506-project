...
public class MyLinkedList {
    ...
    public void insert(int key, int value){
        MyLink newLink = new MyLink(key, value);//要插入的Link节点
        MyLink previous = null;//前一个link节点
        MyLink current = first;//因为是有序链表，从第一个开始
        while(current != null && key > current.key){//当前link不是空，插入的数据大于当前link值
    ...
    public MyLink delete(int key){
        ...
        MyLink previous = first;//记录上一个Link,因为要删除节点，节点的指向要发生变化
        while(current.key != key){
